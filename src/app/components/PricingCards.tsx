...
const PricingCards = () => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 justify-center items-center mt-12 max-w-5xl mx-auto place-items-center">
          ...
          <div key={index} className="flex flex-col items-center">
            <div
              className={`w-full max-w-[320px] border border-[#0000000D] rounded-xl p-6 flex flex-col ${
                plan.isHighlighted ? "bg-[#171717] text-white" : "bg-white"
              }`}
            >
              {/* Badge */}
              <div
